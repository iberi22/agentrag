---
title: "Cortex 0.4.0 Release Changelog"
type: REPORT
...
keywords: [cortex, changelog, benchmarks, locomo, swe-bench]
tags: ["#cortex", "#release", "#benchmarks", "#locomo", "#0.4.0"]
...
- `LoCoMo` benchmark runner that clones the official dataset to a temporary workspace and scores Cortex on QA recall quality.
...
- Architecture clarified to position Cortex as a memory substrate for bidirectional agentic/RAG execution.
...
This moved Cortex from the initial baseline of `0.023191227171872334` Token F1 to `0.06021547660628042`, a `2.60x` improvement on the same slice.
