...
function Invoke-Compose {
    ...
    $env:CORTEX_BENCHMARK_PORT = [string]$HostPort
...
Write-Host "Building Cortex benchmark images..."
Invoke-Compose build cortex-benchmark locomo-benchmark

try {
    Write-Host "Starting Cortex benchmark service..."
    Invoke-Compose @("up", "-d", "--wait", "cortex-benchmark")
